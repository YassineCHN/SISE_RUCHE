...
Enfin le module 6\_Graphe\_competences.py construit un graphe de co-occurrences exploitant NetworkX pour modéliser les relations entre compétences techniques, chaque paire de compétences apparaissant conjointement dans une offre générant une arête pondérée par le nombre de co-occurrences, le graphe étant filtré par seuil minimal configurable et disposé spatialement via un algorithme spring layout tridimensionnel avant rendu Plotly avec nœuds dimensionnés selon le degré de centralité.
