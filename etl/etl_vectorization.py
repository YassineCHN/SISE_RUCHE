...
from config_etl import MOTHERDUCK_DATABASE, EMBEDDING_MODEL, EMBEDDING_DIM
from sentence_transformers import SentenceTransformer

load_dotenv()

class EmbeddingETL:
    def __init__(self, motherduck_db: str, token: str):
    ...
    def generate_embeddings(self, df: pd.DataFrame, batch_size: int = 32) -> pd.DataFrame:
